...
def forward(x, nextSeqNbr, result):
    global channel
    global situation
    global stations
    global FailedItem
    ...
    if itemCode in FailedItem:
        msgdtl["TransactionResult"] = False
...
def callback(ch, method, properties, body):
    ...
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("\n")
    result = reply["SignalData"]["TransactionResult"]

    if reply["SignalData"]["TransactionResult"] == False:
        FailedItem.append(reply["SignalData"]["ItemCode"])
